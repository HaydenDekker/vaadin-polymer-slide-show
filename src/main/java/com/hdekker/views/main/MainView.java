package com.hdekker.views.main;
...
import com.hdekker.views.about.AboutView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "ComponentTest", shortName = "ComponentTest",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "ComponentTest logo"));
        logoLayout.add(new H1("ComponentTest"));
